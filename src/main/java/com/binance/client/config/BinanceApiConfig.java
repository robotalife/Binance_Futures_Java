package com.binance.client.config;
...
public class BinanceApiConfig {
     ...
     */
    private static final String TESTNET_DOMAIN = "binancefuture.com";
    ...
    public static String getStreamApiBaseUrl() {
        return String.format("wss://fstream-auth.%s:9443/ws", getBaseDomain());
    }
